...
* 
*/
class modZip_tn extends DolibarrModules
{
...
//        )
	...
	public $name = "Tunisia Zip Code List";

	/** @var string Module short description */
	public $description = "Autocomplete Tunisia Zip Code";

	/** @var string Module long description */
	public $descriptionlong = "Autocomplete Tunisia Zip Code for zipTN1.0 for Dolibarr 0.9.0";

	/**
	 * @var string Module editor name
	 * @since 4.0
	 */
	public $editor_name = "KB2i Knowledge & Business Intelligence Integration";

	/**
	 * @var string Module editor website
	 * @since 4.0
	 */
	public $editor_url = "http://www.kb2i.com";
	...
	public $config_page_url = 'askri.nasredinne@gmail.com';
	...
	public $need_dolibarr_version = array(5, 0);

	/** @var string[] List of language files */
	public $langfiles = array('askri.nasredinne@gmail.com');
	...
	public function __construct($db)
	{
		...
		// Dictionaries
		if (! isset($conf->Zip_tn->enabled)) {
			$conf->Zip_tn=new stdClass();
			$conf->Zip_tn->enabled = 0;
		}
	...
	{
		return $this->_load_tables('/Zip_tn/sql/');
	}
